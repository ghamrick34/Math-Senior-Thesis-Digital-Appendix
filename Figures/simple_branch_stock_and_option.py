...
ax1.annotate('$S_u$', # this is the text
...
ax1.annotate('$S_d$', # this is the text
...
ax1.annotate('$S_0$', # this is the text
...
ax2.scatter(day,price, s=scale, c=colors, marker=marker, zorder=2)
    ...
    # Label each point with the price
ax2.annotate('$U$', # this is the text
    (1.2,11), # this is the point to label
    va='center',
    ha='center',
    c=colors,
...
ax2.annotate('$D$', # this is the text
    (1.2,9), # this is the point to label
    va='center',
    ha='center',
    c=colors,
...
ax1.set_ylabel('Price ($)', fontname=font, fontsize=18, weight='bold')
ax1.set_title('MSFT Share Price Tree', fontname=font, fontsize=20, weight='bold')

ax2.set_xlabel('Time (t)', fontname=font, fontsize=18, weight='bold')
#ax2.set_ylabel('Value ($)', fontname=font, fontsize=18, weight='bold')
ax2.set_title('MSFT Option Value Tree', fontname=font, fontsize=20, weight='bold')
